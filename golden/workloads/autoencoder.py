...
def get_output(batch, inputs, outputs, dtype, dataflow, iterations, m_tile, k_tile, n_tile):
    ...
    model.add(Dense(N=128, shift=5, relu=True, m_tile=m_tile, k_tile=k_tile, n_tile=n_tile, dtype=dtype, dataflow=dataflow))
    model.add(Dense(N=128, shift=5, relu=True, m_tile=m_tile, k_tile=k_tile, n_tile=n_tile, dtype=dtype, dataflow=dataflow))
    model.add(Dense(N=128, shift=5, relu=True, m_tile=m_tile, k_tile=k_tile, n_tile=n_tile, dtype=dtype, dataflow=dataflow))
    model.add(Dense(N=8  , shift=5, relu=True, m_tile=m_tile, k_tile=k_tile, n_tile=n_tile, dtype=dtype, dataflow=dataflow))
    model.add(Dense(N=8  , shift=5, relu=True, m_tile=m_tile, k_tile=k_tile, n_tile=n_tile, dtype=dtype, dataflow=dataflow))
    model.add(Dense(N=128, shift=5, relu=True, m_tile=m_tile, k_tile=k_tile, n_tile=n_tile, dtype=dtype, dataflow=dataflow))
    model.add(Dense(N=128, shift=5, relu=True, m_tile=m_tile, k_tile=k_tile, n_tile=n_tile, dtype=dtype, dataflow=dataflow))
    model.add(Dense(N=128, shift=5, relu=True, m_tile=m_tile, k_tile=k_tile, n_tile=n_tile, dtype=dtype, dataflow=dataflow))
